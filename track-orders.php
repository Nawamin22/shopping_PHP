					...
					<div class="col-md-12">
						...
						<form class="register-form outer-top-xs" role="form" method="post" action="order-details.php" >
							<div class="form-group">
								...
								<input type="text" class="form-control unicase-form-control text-input" style="max-width: 500px;"  name="orderid"
									id="exampleOrderId1">
							</div>
							<div class="form-group">
								<label class="info-title" for="exampleBillingEmail1">Registered Email</label>
								<input type="email" class="form-control unicase-form-control text-input"  style="max-width: 500px;"   name="email"

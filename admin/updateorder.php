...
if (strlen($_SESSION['alogin']) == 0) {
  ...
  if (isset($_POST['submit2'])) {
    ...
    // $totalPriceQuery = mysqli_query($con, "SELECT totalPrice FROM orders WHERE id='$oid'");
    // $totalPriceRow = mysqli_fetch_array($totalPriceQuery);
    ...
    if ($status == 'Close') {
      ...
      $mail->isHTML(true);
      $mail->Subject = 'Order Close';
      $mail->Body = 'Order with ID ' . $oid . ' has been Closed.';
    ...
    <div style="margin-left:50px;">
      <form name="updateticket" id="updateticket" method="post">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <!-- <tr height="30">
            <td class="fontkink1"><b>Total Price:</b></td>
            <td class="fontkink">
              <?php echo number_format($totalPriceQuery, 2) . ' บาท'; ?>
            </td>
          </tr> -->

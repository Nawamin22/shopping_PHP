...
<head>
	...
	<title>Vintage Shirt Shop Home Page</title>
			...
			<div class="furniture-container homepage-container">
						...
						<div id="hero" class="homepage-slider3">
							<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
								<div class="full-width-slider">
									<div class="item" style="background-image: url(assets/images/sliders/vtsli1.jpg
			);">
										<!-- /.container-fluid -->
									</div><!-- /.item -->
								...
								<div class="full-width-slider">
									<div class="item full-width-slider"
										style="background-image: url(assets/images/sliders/vtsli2.jpg);">
									</div><!-- /.item -->
								</div><!-- /.full-width-slider -->
								...
								<div class="row">
									...
									<div class="hidden-md col-sm-4 col-lg-4">
										<div class="info-box">
											...
											<h6 class="text">free ship-on oder over THB. 600.00</h6>
										</div>
									</div><!-- .col -->
				...
				<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
					<div class="more-info-tab clearfix">
						<h3 class="new-product-title pull-left">MOVIE SHIRT</h3>
						<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
							<li class="active"><a href="#all" data-toggle="tab">All</a></li>
							<li><a href="#books" data-toggle="tab">Band</a></li>
							<li><a href="#furniture" data-toggle="tab">Jacket</a></li>
						</ul><!-- /.nav-tabs -->
					</div>
												...
												<div class="product">
													...
													<div class="product-info text-left">
														...
														<div class="product-price">
															...
															<span class="price-before-discount">THB.
					...
					<div class="row">
						<div class="col-md-6">
							<section class="section">
								<h3 class="section-title">Long-Sleeved Shirt</h3>
						...
						<div class="col-md-6">
							<section class="section">
								<h3 class="section-title">Jacket Movie</h3>
								<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme"
									data-item="2">
									<?php
									$ret = mysqli_query($con, "select * from products where category=4 and subCategory=1");
									while ($row = mysqli_fetch_array($ret)) {
										?>
				...
				<section class="section featured-product inner-xs wow fadeInUp">
					<h3 class="section-title">Hawaii</h3>

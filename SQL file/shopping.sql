...
CREATE TABLE `admin` (
  ...
  `updationDate` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
...
INSERT INTO `admin` (`id`, `username`, `password`, `email`, `creationDate`, `updationDate`) VALUES
(1, 'admin', '96e79218965eb72c92a549dd5a330112', 'nwmin13@gmail.com', '2017-01-24 16:21:18', '13-10-2023 09:49:04 PM');
...
CREATE TABLE `category` (
  ...
  `categoryDescription` longtext CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `creationDate` timestamp NOT NULL DEFAULT current_timestamp(),
  `updationDate` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
(3, 'Band shirt', 'singer and band', '2017-01-24 19:17:37', '30-01-2017 12:22:24 AM'),
(4, 'Movie shirt', 'Classic and Present Movie', '2017-01-24 19:19:32', ''),
(5, 'Jacket', 'jacket', '2017-01-24 19:19:54', ''),
(6, 'Hawaiian shirt', 'hawaii', '2017-02-20 19:18:52', ''),
(7, 'Cartoot shirt', 'Cartoon and Animation', '2023-08-20 12:13:04', NULL),
(8, 'Other shirt', 'etc.', '2023-08-20 12:24:50', NULL);
...
CREATE TABLE `orders` (
  ...
  `productId` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL,
  `orderDate` timestamp NOT NULL DEFAULT current_timestamp(),
  `paymentMethod` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `orderStatus` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `paymentImage1` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `ordertrackhistory` (
  ...
  `remark` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `productreviews` (
  ...
  `review` longtext CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `productCompany` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `productPrice` int(11) DEFAULT NULL,
  `productPriceBeforeDiscount` int(11) DEFAULT NULL,
  `productDescription` longtext CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `productImage1` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `productImage2` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `productImage3` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `shippingCharge` int(11) DEFAULT NULL,
  `productAvailability` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
(23, 4, 2, 'seven 90s', 'none', 250, 250, '<div>Pattern: Solid / Soft</div><div>Sleeve: Length / Short / Medium</div><div>Short: Sleeve</div><div>Size: XL</div><div>Color: White / Black / Brown / RGB</div><div>Material: Cotton</div><div>Vintage: Yes</div><div>Fit: Regular</div><div>Brand: Unbranded</div><div>Department:&nbsp; Unisex Adults</div><div>Type:&nbsp; T-Shirt</div><div>Theme:&nbsp; 90s</div><div>Vintage Shop</div>		', 's-l1200.jpg', 's-l1200 (1).jpg', 's-l1200.jpg', 30, 'In Stock', '2023-10-29 17:58:47', NULL),
(24, 3, 15, 'ACDC 2000s', 'none', 250, 250, '<div>Pattern: Solid / Soft</div><div>Sleeve: Length / Short / Medium</div><div>Short: Sleeve</div><div>Size: XL</div><div>Color: White / Black / Brown / RGB</div><div>Material: Cotton</div><div>Vintage: Yes</div><div>Fit: Regular</div><div>Brand: Unbranded</div><div>Department:&nbsp; Unisex Adults</div><div>Type:&nbsp; T-Shirt</div><div>Theme:&nbsp; 90s</div><div>Vintage Shop</div>		', 'il_fullxfull.2193710832_cwuy.jpg', 's-l1600.jpg', 's-l1200.jpg', 30, 'In Stock', '2023-10-29 18:01:01', NULL),
(25, 4, 3, 'Back to the feture 80s', 'none', 200, 200, '<div>Pattern:&nbsp; Soft</div><div>Sleeve: Short</div><div>Short: Sleeve</div><div>Size: XL</div><div>Color:&nbsp; Black&nbsp;</div><div>Material: Cotton</div><div>Vintage: Yes</div><div>Fit: Regular</div><div>Brand: Unbranded</div><div>Department:&nbsp; Unisex Adults</div><div>Type:&nbsp; T-Shirt</div><div>Theme:&nbsp; 90s</div><div>Vintage Shop</div>			', 'Back-to-the-Future-3D-Printed-Tank-Tops-Men-s-Clothing-Spring-Summer-Harajuku-Streetwear-Oversized.jpg', 'back-to-the-future-2-poster-tank-top-2__56571.jpg', 'GUEST_6f499adb-7daf-4a92-a799-66e61955346c.jpg', 30, 'In Stock', '2023-10-29 18:13:21', NULL),
(26, 3, 15, 'kiss 1995 rose', 'none', 250, 250, '<div>Pattern: Solid / Soft</div><div>Sleeve: Length / Short / Medium</div><div>Short: Sleeve</div><div>Size: XL</div><div>Color: White / Black / Brown / RGB</div><div>Material: Cotton</div><div>Vintage: Yes</div><div>Fit: Regular</div><div>Brand: Unbranded</div><div>Department:&nbsp; Unisex Adults</div><div>Type:&nbsp; T-Shirt</div><div>Theme:&nbsp; 90s</div><div>Vintage Shop</div>			', '901e4f37abedd41fa0fa53db58a58c66.jpg', '5a2675560f5f3b3e1305a13426640ba7.jpg', 'DSC03301.JPG', 30, 'In Stock', '2023-10-29 18:14:43', NULL);
...
(1, 4, 'Jacket', '2017-01-30 16:55:48', ''),
(2, 4, 'Short-sleeved', '2017-02-04 04:13:27', ''),
(3, 4, 'Sleeveless shirt', '2017-02-04 04:13:00', ''),
(4, 4, 'Long-sleeved shirt', '2017-01-26 16:29:09', ''),
(13, 3, 'Jacket', '2023-08-20 12:28:44', NULL),
(15, 3, 'Short-sleeved', '2017-02-04 04:13:54', ''),
(16, 3, 'Long-sleeved shirt', '2023-08-20 12:28:44', NULL),
(17, 3, 'Sleeveless shirt', '2017-02-04 04:13:54', ''),
(21, 5, 'Leather', '2017-02-04 04:36:45', ''),
(23, 5, 'Jeans', '2017-02-04 04:37:02', ''),
(24, 5, 'Nylon ', '2017-02-04 04:37:51', ''),
(31, 7, 'Blue Sky', '2017-02-04 04:36:45', ''),
(32, 7, 'DreamWorks', '2017-02-04 04:36:45', ''),
(33, 7, 'Pixar', '2017-02-04 04:36:45', ''),
(34, 7, 'Nickelodeon ', '2017-02-04 04:36:45', ''),
(35, 7, 'Warner Bros', '2017-02-04 04:36:45', ''),
(36, 7, 'Sony Pictures', '2017-02-04 04:36:45', ''),
(37, 7, 'Cartoon Network', '2017-02-04 04:36:45', ''),
(43, 6, 'Topman', '2017-02-04 04:37:51', ''),
(44, 6, 'Ralph Lauren', '2017-02-04 04:37:51', ''),
(45, 6, 'Kalaheo', '2017-02-04 04:37:51', ''),
(46, 6, 'Sunsurf', '2017-02-04 04:37:51', ''),
(47, 6, 'Nativeyouth', '2017-02-04 04:37:51', ''),
(55, 7, 'Walt Disney', '2017-02-04 04:36:45', ''),
(74, 8, 'Other', '2017-03-10 20:12:59', ''),
(77, 8, 'Jacket', '2017-01-30 16:55:48', '');
...
CREATE TABLE `userlog` (
  ...
  `logout` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `shippingAddress` longtext CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `shippingState` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `shippingCity` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `shippingPincode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `regDate` timestamp NOT NULL DEFAULT current_timestamp(),
  `updationDate` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `district_id` int(11) DEFAULT NULL,
  `province_id` int(11) DEFAULT NULL,
  `amphure_id` int(11) DEFAULT NULL,
  `localAddress` longtext CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `reset_token` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `users` (`id`, `name`, `email`, `contactno`, `password`, `shippingAddress`, `shippingState`, `shippingCity`, `shippingPincode`, `regDate`, `updationDate`, `district_id`, `province_id`, `amphure_id`, `localAddress`, `reset_token`) VALUES
(4, 'nawamin saengsaikaew', 'nwmin30@gmail.com', 973377713, '96e79218965eb72c92a549dd5a330112', '515', 'Pathum Thani', 'Nong Suea', 'Bueng Bon', '2023-09-04 14:00:53', '24-10-2023 06:33:55 AM', 130402, 4, 69, '515', '');

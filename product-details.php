									...
									<div class="item">
										<div class="products">
											...
											<div class="product-info text-left m-t-20">
												<h3 class="name"><a
														href="product-details.php?pid=<?php echo htmlentities($rws['id']); ?>">
															...
															<?php if ($row['productAvailability'] == 'In Stock') { ?>
																...
																<a
																	...
																	<button class="btn btn-primary" type="button">Add to
																		cart</button></a>
															<?php } else { ?>
																<div class="action" style="color:red">Hot Deal</div>
															<?php } ?>
															...
															<div class="form-container">
																...
																<div class="row">
																	<div class="col-sm-6">
																		...
																		<div class="form-group">
																			<label for="exampleInputSummary">Summary Review <span
																					class="astk">*</span></label>
																			<input type="text" class="form-control txt"
																	...
																	<div class="col-md-6">
																		<div class="form-group">
																			<label for="exampleInputReview">Review Details <span
																					class="astk">*</span></label>
						...
						<div class="products">
							<div class="product">
								...
								<div class="product-info text-left">
									<h3 class="name"><a
											href="product-details.php?pid=<?php echo htmlentities($rw['id']); ?>">

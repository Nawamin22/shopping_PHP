...
if (strlen($_SESSION['login']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		// อัปเดตช่อง paymentMethod ในตาราง orders
		mysqli_query($con, "UPDATE orders SET paymentMethod = '" . $_POST['paymethod'] . "', paymentImage1 = '$paymentImage' WHERE userId = '" . $_SESSION['id'] . "' AND paymentMethod IS NULL");

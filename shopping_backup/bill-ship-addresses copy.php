...
if (strlen($_SESSION['login']) == 0) {
	...
	<head>
		...
		if (isset($_POST['localaddress']) && isset($_POST['provinces']) && isset($_POST['amphures']) && isset($_POST['districts'])) {
			$localAddress = $_POST['localaddress'];
			$province_id = $_POST['provinces'];
			$amphure_id = $_POST['amphures'];
			$district_id = $_POST['districts'];

			// อัปเดตค่าใน Shipping Address ด้วยข้อมูล Local Address และข้อมูลอื่น ๆ ตามที่คุณต้องการ
			$query = mysqli_query($con, "UPDATE users SET shippingAddress='$localAddress', shippingState=(SELECT name_en FROM provinces WHERE id='$province_id'), shippingCity=(SELECT name_en FROM amphures WHERE id='$amphure_id'), shippingPincode=(SELECT name_en FROM districts WHERE id='$district_id') WHERE id='" . $_SESSION['id'] . "'");

			if ($query) {
				echo "Local Address has been updated";
			} else {
				echo "Error updating Local Address";
			}
		} else {
			echo "Invalid data";
		}
													...
													while ($row = mysqli_fetch_array($query)) {
														...
														<form class="register-form" role="form" method="post">
															...
															<div class="form-group">
																...
																<select class="form-control" id="shippingcity"
															...
															<div class="form-group">
																...
																<select class="form-control" id="shippingpincode"
																	name="shippingpincode" required>
